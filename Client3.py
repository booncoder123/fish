...
class Client:
    ...
    def handle_msg(self, msg):
        ...
        if(msg_action == "SEND"):
            # Update in the dict key = pondname, values = <PondData>
            self.other_ponds[msg_object.pondName] = msg_object
...
if __name__ == "__main__":
    ...
    f1 = FishData("PEEM", "151451")
    f2 = FishData("PEEM", "125413")
    p = PondData("PEEM")
    p.addFish(f1)
    p.addFish(f2)
    connected = True
